...
S.1415 <- read.csv("[path to dir]/Bruins Start Fires/2014-2015Season.csv", stringsAsFactors = FALSE)
S.1516 <- read.csv("[path to dir]/Bruins Start Fires/2015-2016Season.csv", stringsAsFactors = FALSE)
S.1617 <- read.csv("[path to dir]/Bruins Start Fires/2016-2017Season.csv", stringsAsFactors = FALSE)
S.1718 <- read.csv("[path to dir]/Bruins Start Fires/2017-2018Season.csv", stringsAsFactors = FALSE)
P.1617 <- read.csv("[path to dir]/Bruins Start Fires/2016-2017Playoff.csv", stringsAsFactors = FALSE)
P.1718 <- read.csv("[path to dir]/Bruins Start Fires/2017-2018Playoff.csv", stringsAsFactors = FALSE)
